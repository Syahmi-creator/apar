...
Route::get('/dashboard/file-import-export', [StudentGraduateController::class, 'uploadStudentGraduates']);
Route::post('/dashboard/file-import', [StudentGraduate::class, 'fileImport'])->middleware(['auth'])->name('dashboard.file-import');
Route::get('/dashboard/file-export', [StudentGraduate::class, 'fileExport'])->middleware(['auth'])->name('dashboard.file-export');
